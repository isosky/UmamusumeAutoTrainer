...
race_list_dahechiji = [1701, 2303, 2703, 2905, 3103, 3303, 3403, 4408, 4506, 4608, 4804, 5407, 5605, 6006, 6701, 6807, 7008, 7204]
race_list_shenying = [2303, 2501, 2703, 2905, 3104, 3303, 3404, 3601, 4301, 4607, 5709, 5904, 6006, 6601, 7008, 7204]
expect_attribute_shenying = [1000, 700, 700, 250, 400]
learn_skill_list_shenying = ['圆弧艺术家', '弧线大师', '最后冲刺', '春季优俊少女', '逆时针']
race_list_dashukuaiche = [2303, 2501, 2703, 2905, 3104, 3303, 3601, 4301, 4607, 5201, 5709, 5904, 6601, 6703, 7007]
expect_attribute_dashukuaiche = [1100, 600, 700, 250, 400]
learn_skill_list_dashukuaiche = ['弧线大师', '最后冲刺', '春季优俊少女', '逆时针', '专注力']

race_list_xiaolimao = [1601, 2401, 3104, 3404, 4409, 5407, 5605, 5709, 5904, 6006]
expect_attribute_xiaolimao = [1000, 600, 600, 250, 400]
learn_skill_list_xiaolimao = ['圆弧艺术家', '弧线大师', '最后冲刺', '春季优俊少女', '逆时针']

# 一颗安心糖
# 从网页生成 TODO 改成读配置文件 TODO 改成命令行 TODO
attachment_data = {'expect_attribute': expect_attribute_xiaolimao, 'follow_support_card_name': '一颗安心糖', 'follow_support_card_level': 50, 'extra_race_list': race_list_xiaolimao,
                   'learn_skill_list': learn_skill_list_xiaolimao, 'tactic_list': [4, 4, 4], 'clock_use_limit': 3, 'learn_skill_threshold': 500, 'allow_recover_tp': False,
